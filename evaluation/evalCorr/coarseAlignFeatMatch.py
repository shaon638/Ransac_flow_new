...
sys.path.append('/home2/shaon/RANSAC-Flow/segNet')
import segEval
...
class CoarseAlign:
    def __init__(self, nbScale, nbIter, tolerance, transform, minSize, segId, segFg, scaleR = 2, imageNet = True, segNet = True):
        ...
        self.net.eval()
        if segNet : 
            self.segNet = segEval.SegNet('/ssd_scratch/cvit/shaon/pretrained_models/ade20k_resnet50dilated_encoder.pth', '/ssd_scratch/cvit/shaon/pretrained_models/ade20k_resnet50dilated_decoder.pth', segId, segFg)
        ## preprocessing
